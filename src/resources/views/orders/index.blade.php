                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-1">{{ $product->largeCategory->name ?? '' }}</td>
                                                <td class="col-2">{{ $product->description }}</td>
                                                <td class="col-2"><img class="img-responsive" style="max-width: 100%;" src="{{ config('app.image_domain') .'/'. $product->image_url }}" alt="Product image"></td>
